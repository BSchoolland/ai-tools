...
var chatbotManager_exports = {};
__export(chatbotManager_exports, {
  ChatbotManager: () => ChatbotManager
});
module.exports = __toCommonJS(chatbotManager_exports);
...
class Conversation {
  constructor(conversationID, chatbotType = null, existingChatbot = null, saveCallback = null) {
    ...
    this.chatbot = existingChatbot || new import_chatbot.ChatBot({
  ...
  async getConversation({
    ...
    if (this.loadCallback && !existingChatbot) {
      try {
        ...
        if (savedHistory) {
          const loadedChatbot = new import_chatbot.ChatBot({
